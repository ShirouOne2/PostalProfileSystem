...
public class PostalOfficeEditController {
     ...
     * @param id The ID of the postal office
     * @return The postal office data as a Map
     */
    ...
    public ResponseEntity<Map<String, Object>> getPostalOfficeById(@PathVariable Integer id) {
        try {
            ...
            Map<String, Object> officeData = convertToEditDTO(office);
     ...
     * @param id The ID of the postal office to update
     * @param requestData The updated data
    ...
    public ResponseEntity<Map<String, Object>> updatePostalOffice(
        ...
        try {
            ...
            if (requestData.containsKey("name")) {
                office.setName((String) requestData.get("name"));
            }
            if (requestData.containsKey("postmaster")) {
                office.setPostmaster((String) requestData.get("postmaster"));
            }
            if (requestData.containsKey("address")) {
                office.setAddress((String) requestData.get("address"));
            }
            if (requestData.containsKey("zipCode")) {
                office.setZipCode((String) requestData.get("zipCode"));
            }
            
            // Update connection status
            if (requestData.containsKey("connectionStatus")) {
                Boolean status = (Boolean) requestData.get("connectionStatus");
                office.setConnectionStatus(status);
            }
            
            // Update ISP information
            if (requestData.containsKey("internetServiceProvider")) {
                office.setInternetServiceProvider((String) requestData.get("internetServiceProvider"));
            }
            if (requestData.containsKey("speed")) {
                office.setSpeed((String) requestData.get("speed"));
            }
            if (requestData.containsKey("typeOfConnection")) {
                office.setTypeOfConnection((String) requestData.get("typeOfConnection"));
            }
            if (requestData.containsKey("staticIpAddress")) {
                office.setStaticIpAddress((String) requestData.get("staticIpAddress"));
            }
            
            // Update staff information
            if (requestData.containsKey("noOfEmployees")) {
                office.setNoOfEmployees((Integer) requestData.get("noOfEmployees"));
            }
            if (requestData.containsKey("noOfPostalTellers")) {
                office.setNoOfPostalTellers((Integer) requestData.get("noOfPostalTellers"));
            }
            if (requestData.containsKey("noOfLetterCarriers")) {
                office.setNoOfLetterCarriers((Integer) requestData.get("noOfLetterCarriers"));
            }
            
            // Update contact information
            if (requestData.containsKey("postalOfficeContactPerson")) {
                office.setPostalOfficeContactPerson((String) requestData.get("postalOfficeContactPerson"));
            }
            if (requestData.containsKey("postalOfficeContactNumber")) {
                office.setPostalOfficeContactNumber((String) requestData.get("postalOfficeContactNumber"));
            }
            if (requestData.containsKey("ispContactPerson")) {
                office.setIspContactPerson((String) requestData.get("ispContactPerson"));
            }
            if (requestData.containsKey("ispContactNumber")) {
                office.setIspContactNumber((String) requestData.get("ispContactNumber"));
            }
            ...
            if (requestData.containsKey("classification")) {
                office.setClassification((String) requestData.get("classification"));
            }
            if (requestData.containsKey("serviceProvided")) {
                office.setServiceProvided((String) requestData.get("serviceProvided"));
            }
    ...
    private Map<String, Object> convertToEditDTO(PostalOffice office) {
        ...
        if (office.getArea() != null) {
            data.put("areaId", office.getArea().getId());
            data.put("areaName", office.getArea().getAreaName());
        }
        if (office.getRegion() != null) {
            data.put("regionId", office.getRegion().getId());
            data.put("regionName", office.getRegion().getName());
        }
        if (office.getProvince() != null) {
            data.put("provinceId", office.getProvince().getId());
            data.put("provinceName", office.getProvince().getName());
        }
        if (office.getCityMunicipality() != null) {
            data.put("cityMunicipalityId", office.getCityMunicipality().getId());
            data.put("cityMunicipalityName", office.getCityMunicipality().getName());
        }
        if (office.getBarangay() != null) {
            data.put("barangayId", office.getBarangay().getId());
            data.put("barangayName", office.getBarangay().getName());
        }
